     ...
     const filter = inventors.filter(inventor => inventor.year<1600 && inventor.year>1499);
     console.log(filter);
    ...
    const birthdate = inventors.sort(function(inventor1, inventor2){
    ...
    de.filter(streetName => streetName.includes('de'));
      ...
      people.sort((person1, person2) => person1.split(", ")[1] - person2.split(", ")[1]);
